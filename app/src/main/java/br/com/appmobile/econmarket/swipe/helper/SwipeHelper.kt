package br.com.appmobile.econmarket.swipe.helper
...
abstract class SwipeHelper(context: Context, private val recyclerView: RecyclerView, internal var buttonWidth:Int) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {

    private var buttonList: MutableList<ButtonSwipe>? = null
    lateinit var gestureDetector: GestureDetector
    var swipePosition = 1
    var swipeThreshold = 0.5f
    val buttonBuffer: MutableMap<Int, MutableList<ButtonSwipe>>
    lateinit var removerQueue: LinkedList<Int>

    abstract fun instantiateMyButton(viewHolder: RecyclerView.ViewHolder, buffer: MutableList<ButtonSwipe>)
    ...
    override fun onChildDraw(
        ...
        if(actionState == ItemTouchHelper.ACTION_STATE_SWIPE){
            ...
            if(dX < 0){
                ...
                var buffer: MutableList<ButtonSwipe> = ArrayList()
    ...
    private fun drawButton(c: Canvas, itemView: View, buffer: MutableList<ButtonSwipe>, pos: Int, translationX: Float) {
