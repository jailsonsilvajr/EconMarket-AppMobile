package br.com.appmobile.econmarket.swipe.button
...
class ButtonSwipe(private val context: Context,
                  private val text:String,
                  private val textSize:Int,
                  private val imageResIId: Int,
                  private val color:Int,
                  private val listener: ButtonSwipeClickListener) {
    ...
    fun onDraw(c: Canvas, rectF: RectF, position: Int){
        ...
        if(imageResIId == 0){
            ...
            val d = ContextCompat.getDrawable(context, imageResIId)
